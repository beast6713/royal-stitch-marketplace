    ...
    return (
      <main className="shell flex min-h-[calc(100vh-5rem)] items-center py-10">
        <div className="panel-dark w-full p-8 sm:p-10">
          ...
          <h1 className="mt-5 text-5xl text-white">Add Clerk keys to enable sign in.</h1>
          <p className="mt-4 max-w-2xl text-base text-white/75">
            This marketplace gracefully previews without auth, but buyer and seller sign-in requires
            Clerk environment variables from the dashboard.
          </p>
        </div>
      </main>
    );
      ...
      <div className="panel-dark grid w-full overflow-hidden lg:grid-cols-[1fr,0.9fr]">
        <div className="flex flex-col justify-between gap-8 px-8 py-10 sm:px-10">
          <div className="space-y-5">
            ...
            <h1 className="text-5xl text-white">Sign in to manage your handmade storefront.</h1>
            <p className="max-w-xl text-base text-white/75">
              Buyers can explore the full catalog, while sellers unlock the protected dashboard to
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="rounded-3xl border border-white/10 bg-white/10 p-4 text-white/75">
              ...
              <p className="mt-3 text-sm font-semibold text-white">Google or email authentication</p>
            </div>
            <div className="rounded-3xl border border-white/10 bg-white/10 p-4 text-white/75">
              <Sparkles className="h-5 w-5 text-champagne" />
              <p className="mt-3 text-sm font-semibold text-white">Buyer and seller role support</p>
            </div>
          </div>
        </div>
